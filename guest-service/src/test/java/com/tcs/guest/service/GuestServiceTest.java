...
import com.tcs.guest.exception.GuestNotFoundException;
import com.tcs.guest.mapper.UserMapperImpl;
import com.tcs.guest.repository.GuestRepository;
import com.tcs.guest.service.GuestServiceImpl;
...
class GuestServiceTest {
	...
	void setup() {
		...
		creditCards.add(new CreditCardDto(1,1234567890L, "12/23", "Zafrul", "Visa"));
