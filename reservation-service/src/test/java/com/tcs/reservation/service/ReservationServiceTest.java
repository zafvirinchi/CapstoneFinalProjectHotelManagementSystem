...
import com.tcs.reservation.model.CreditCard;
import com.tcs.reservation.model.Hotel;
import com.tcs.reservation.model.HotelAddress;
import com.tcs.reservation.model.Payment;
import com.tcs.reservation.model.Profile;
import com.tcs.reservation.model.Room;
import com.tcs.reservation.model.RoomType;
import com.tcs.reservation.model.User;
import com.tcs.reservation.repository.ReservationRepository;
import com.tcs.reservation.service.ReservationServiceImpl;
...
class ReservationServiceTest {
	...
	void addReservationTest() {
		User user = new User();
		user.setStatus(true);
		user.setUserName("Zafrul");
		user.setPassword("test");
		List<CreditCard> creditCards = new ArrayList<>();
		creditCards.add(new CreditCard(1, 1234567890, "12/24", "Zafrul", "Visa"));
		user.setCreditCards(creditCards);
		user.setProfile(new Profile(1, "Zafrul", "Islam", "zafrul.techstack75@gmail.com", 01712232327, "Data",
				"Rafat", "Indore", 1212, "India"));
